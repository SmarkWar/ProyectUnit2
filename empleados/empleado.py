...
class Empleado(Usuario):
    ...
    def __init__(self, nombre: str, apellido: str, fecha_nacimiento: datetime, curp: str, contrasenia: str, fecha_ingreso_trabajador: datetime, rfc: str, salario: float, horario: str, rol: Rol):
